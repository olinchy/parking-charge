...
public class TestChargerRoad2 {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(
                ...
                new Object[]{
                        // sedan on Road, more than 12 and over night
                        new CarRecord(CarTypes.sedan, date("2017-10-12 17:35:00"), date("2017-10-13 09:51:00")), 87}  ,
                new Object[]{
                        // sedan on Road, more than 12 and over night
                        new CarRecord(CarTypes.sedan, date("2017-10-12 17:35:00"), date("2017-10-13 10:05:00")), 90}        
