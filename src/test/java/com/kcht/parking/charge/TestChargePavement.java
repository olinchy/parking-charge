...
public class TestChargePavement {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(
                ...
                new Object[]{new Car(CarTypes.sedan, date("2017-02-10 21:32:00"), date("2017-02-11 08:15:00")), 22},
                ...
                //day in,same day out
                new Object[]{new Car(CarTypes.sedan, date("2017-02-10 23:32:00"), date("2017-02-11 06:15:00")), 6},
                //night in,same night out
                new Object[]{new Car(CarTypes.sedan, date("2017-02-10 23:32:00"), date("2017-02-11 23:15:00")), 46},
                //night in,another night out
                new Object[]{new Car(CarTypes.sedan, date("2017-02-10 07:32:00"), date("2017-02-12 21:15:00")), 126},
