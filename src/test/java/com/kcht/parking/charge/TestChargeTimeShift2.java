...
public class TestChargeTimeShift2 {
	
	
	
    public TestChargeTimeShift2( final Car car, final double expected) {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(
              //  new Object[]{new Car(CarTypes.sedan, date("2017-02-10 07:45:00"), date("2017-02-10 07:48:00")),0},
                ...
                new Object[]{ new Car(CarTypes.sedan, date("2017-02-10 21:32:00"), date("2017-02-11 08:15:00")), 14},//day in,another day out 
                ...
                new Object[]{new Car(CarTypes.sedan, date("2017-02-10 23:32:00"), date("2017-02-11 06:15:00")),0},//night in,same night out 
               
                
                new Object[]{new Car(CarTypes.sedan, date("2017-02-10 23:32:00"), date("2017-02-11 23:15:00")),38},//night in,another night out 
               
                
                new Object[]{new Car(CarTypes.sedan, date("2017-02-10 07:32:00"), date("2017-02-12 21:15:00")),110},//day in,after two days out
                	// 大于12小时过夜
